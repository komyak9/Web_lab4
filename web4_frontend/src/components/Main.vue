                  ...
                  <td>
                    <div id="svg-picture">
                      <svg id="svg" width="386" height="386" xmlns="http://www.w3.org/2000/svg" @click="clickOnSVG">
                        <polygon points="193,123 193,193 263,193" class="svg-figure-color" stroke-width="2"></polygon>
                        <polygon points="123,193 123,53 193,53 193,193" class="svg-figure-color" stroke-width="2"></polygon>
                        <path d="M193,193 L53,193 A153,153 1 0,0 193,333  z" class="svg-figure-color" stroke-width="2"></path>
                        ...
                        <td>
                          <table id="x-table">
                            <tr>
                              ...
                              <td colspan = "2">
                                <button class="button" @click="undoX">Отменить выбор</button>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" id="inputY" name="y" maxlength="17" autocomplete="off"
                                 placeholder="Введите значение y ∈ [-5; 3]:" v-model="param_y">
                        </td>
                      </tr>
                      <tr class="numbers">
                        <td>R:</td>
            ...
            <td rowspan="2" class="background" id="result-td">
              <div id="result-div">
                <table id="result-table" class="result-style">
                  <thead>
                  <tr>
                    <th id="real-time" class="result-style">Время запроса</th>
  ...
  methods: {
    ...
    checkY(y) {
      ...
      if (!isNaN(y) && parseFloat(y) > MIN && parseFloat(y) < MAX) {
        ...
        this.showError("Проверьте Y: y ∈ [-5; 3]")
        return false;
      }
    },
    ...
    checkR(r) {
      ...
      if (r.length > 0 && !isNaN(r[0]) && parseFloat(r[0]) > MIN && parseFloat(r[0]) <= MAX)
        ...
        this.showError("Выберите R: r ∈ (0;2]")
        return false;
      }
    },
    checkX(x) {
      ...
      if (x.length > 0 && !isNaN(x[0]) && parseFloat(x[0]) >= MIN && parseFloat(x[0]) <= MAX)
        ...
        this.showError("Выберите X: x ∈ [-2;2]")
        return false;
      }
    },
    submit() {
